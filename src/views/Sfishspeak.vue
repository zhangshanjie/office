...
<div class="search">
    <Row>
        <Col>
            <Card>
                <div>
                    <Button @click="addadvertising" icon="plus" type="primary" style="margin-left: 10px">添加渔翁说</Button>
                </div>
                <br>
                <div>
                    <span>时间：</span>
                ...
                <Modal title="添加渔翁说" v-model="modalVisible" :mask-closable='false' :width="500">
                    <Form  :label-width="100" >       
                        ...
                        <FormItem label="内容:">
                            <Input type="textarea"  v-model="advertising.content"/>
                        </FormItem>
                        <FormItem label="是否置顶:">
                            <Select v-model="advertising.isTop">
...
methods: {
    ...
    Stick(v){
        this.$Modal.confirm({
            ...
            onOk: () => {
            // 删除
            this.postRequest("/systemNewsInfo/updateSystemNewsInfo?systemNewsInfoId=" + v.id).then(res => {
                this.$Modal.remove();
                if (res.success) {
